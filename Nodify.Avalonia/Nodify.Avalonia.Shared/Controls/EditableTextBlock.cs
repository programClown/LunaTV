    ...
    public class EditableTextBlock : TemplatedControl
    {
        ...
        public static readonly StyledProperty<bool> IsEditingProperty =
            AvaloniaProperty.Register<EditableTextBlock, bool>(nameof(IsEditing),
                defaultBindingMode: BindingMode.TwoWay, coerce: CoerceIsEditing);

        public static readonly StyledProperty<bool> IsEditableProperty =
            AvaloniaProperty.Register<EditableTextBlock, bool>(nameof(IsEditable), true);
        ...
        public static readonly StyledProperty<bool> AcceptsReturnProperty =
            TextBox.AcceptsReturnProperty.AddOwner<EditableTextBlock>(new StyledPropertyMetadata<bool>(false));
        ...
        public static readonly AttachedProperty<TextWrapping> TextWrappingProperty =
            TextBlock.TextWrappingProperty.AddOwner<EditableTextBlock>(
                new StyledPropertyMetadata<TextWrapping>(TextWrapping.Wrap));
        ...
        public static readonly AttachedProperty<TextTrimming> TextTrimmingProperty =
            TextBlock.TextTrimmingProperty.AddOwner<EditableTextBlock>(
                new StyledPropertyMetadata<TextTrimming>(TextTrimming.CharacterEllipsis));
        ...
        public static readonly StyledProperty<int> MaxLinesProperty =
            TextBox.MaxLinesProperty.AddOwner<EditableTextBlock>();

        public static readonly StyledProperty<int> MaxLengthProperty =
            TextBox.MaxLengthProperty.AddOwner<EditableTextBlock>();

        private static void OnIsEditingChanged(EditableTextBlock editableTextBlock,
            AvaloniaPropertyChangedEventArgs<bool> avaloniaPropertyChangedEventArgs)
        {
        }
        ...
        protected override void OnApplyTemplate(TemplateAppliedEventArgs e)
        {
            ...
            if (TextBox != null)
            {
                ...
                TextBox.GetBindingObservable(IsVisibleProperty)
                    .Subscribe(new AnonymousObserver<BindingValue<bool>>(OnTextBoxVisiblityChanged));
