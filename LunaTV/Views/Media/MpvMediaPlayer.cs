...
/// </summary>
public class MpvMediaPlayer : MediaPlayerBase
{
    static MpvMediaPlayer()
    {
        BackgroundProperty.OverrideMetadata(typeof(MpvMediaPlayer),
            new StyledPropertyMetadata<IBrush?>(new Optional<IBrush?>(Brushes.Black)));
        HorizontalAlignmentProperty.OverrideMetadata(typeof(MpvMediaPlayer),
            new StyledPropertyMetadata<HorizontalAlignment>(HorizontalAlignment.Stretch));
        VerticalAlignmentProperty.OverrideMetadata(typeof(MpvMediaPlayer),
    ...
    private Panel UIParentCache
    {
        get
        {
            ...
            if (_uiParentCache == null)
            {
                throw new NullReferenceException($"{UIPartName} must be within a Panel or Grid control. Container is of type '{UIPart?.Parent?.GetType().Name}'.");
            }
    ...
    public static readonly StyledProperty<string?> TitleProperty =
        AvaloniaProperty.Register<MpvMediaPlayer, string?>(nameof(Title));
    /// <summary>
    ...
    public static readonly StyledProperty<MouseTrigger> MouseFullscreenProperty =
        AvaloniaProperty.Register<MpvMediaPlayer, MouseTrigger>(nameof(MouseFullscreen), MouseTrigger.MiddleClick);
    /// <summary>
    ...
    public static readonly StyledProperty<MouseTrigger> MousePauseProperty =
        AvaloniaProperty.Register<MpvMediaPlayer, MouseTrigger>(nameof(MousePause), MouseTrigger.LeftClick);
    /// <summary>
    ...
    public static readonly StyledProperty<bool> ChangeVolumeOnMouseWheelProperty =
        AvaloniaProperty.Register<MpvMediaPlayer, bool>(nameof(ChangeVolumeOnMouseWheel), true);
    /// <summary>
    ...
    public static readonly StyledProperty<bool> IsPlayPauseVisibleProperty =
        AvaloniaProperty.Register<MpvMediaPlayer, bool>(nameof(IsPlayPauseVisible), true);
    /// <summary>
    ...
    public static readonly StyledProperty<bool> IsStopVisibleProperty =
        AvaloniaProperty.Register<MpvMediaPlayer, bool>(nameof(IsStopVisible), true);
    /// <summary>
    ...
    public static readonly StyledProperty<bool> IsLoopVisibleProperty =
        AvaloniaProperty.Register<MpvMediaPlayer, bool>(nameof(IsLoopVisible), true);
    /// <summary>
    ...
    public static readonly StyledProperty<bool> IsVolumeVisibleProperty =
        AvaloniaProperty.Register<MpvMediaPlayer, bool>(nameof(IsVolumeVisible), true);
    /// <summary>
    ...
    public static readonly StyledProperty<bool> IsSpeedVisibleProperty =
        AvaloniaProperty.Register<MpvMediaPlayer, bool>(nameof(IsSpeedVisible), true);
    /// <summary>
    ...
    public static readonly StyledProperty<bool> IsSeekBarVisibleProperty =
        AvaloniaProperty.Register<MpvMediaPlayer, bool>(nameof(IsSeekBarVisible), true);
    /// <summary>
