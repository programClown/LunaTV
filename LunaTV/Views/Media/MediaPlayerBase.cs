...
public abstract class MediaPlayerBase : ContentControl
{
    ...
    /// </summary>
    public static readonly DirectProperty<MpvMediaPlayer, bool> IsPlayingProperty =
        AvaloniaProperty.RegisterDirect<MpvMediaPlayer, bool>(nameof(IsPlaying), o => o.IsPlaying);
    /// <summary>
    ...
    private void MediaLoadedChanged()
    {
        ...
        _seekCommand?.NotifyCanExecuteChanged();
    }
